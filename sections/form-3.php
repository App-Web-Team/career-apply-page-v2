...
<div class="mt-5">
    <p class="details-heading experience-text text-capitalize">
        ...
        <div class="row f-row">
            <button class="btn add-btn text-capitalize ml-3 experience-add-btn">+ add</button>
        </div>
        <div class="row f-row my-3">
            <p class="please-text ml-3">Please list out all the prof. skills you used throughout the years</p>
        </div>
        ...
        <div class="row f-row my-0 mb-3">
            <button class="btn add-btn text-capitalize ml-3 skills-add-btn">+ add</button>
        </div>
